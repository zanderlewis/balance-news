    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800 flex">
        <flux:sidebar sticky stashable class="h-screen min-h-screen border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group heading="News" class="grid">
                    <flux:navlist.item icon="newspaper" :href="route('home')" :current="request()->routeIs('home')" wire:navigate>Home</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
